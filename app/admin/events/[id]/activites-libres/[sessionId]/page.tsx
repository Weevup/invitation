...
export default function ActivitesLibresDetailPage() {
  ...
  async function fetchGroups() {
    const response = await fetch(`/api/admin/events/${eventId}/sessions/${sessionId}/activites-libres`)
  ...
  async function handleUpdateGroup() {
    ...
    try {
      const response = await fetch(
        `/api/admin/events/${eventId}/sessions/${sessionId}/activites-libres/${editingGroup.id}`,
        {
          method: 'PATCH',
          headers: { 'Content-Type': 'application/json' },
  ...
  async function handleDeleteGroup(groupId: string) {
    ...
    try {
      const response = await fetch(
        `/api/admin/events/${eventId}/sessions/${sessionId}/activites-libres/${groupId}`,
        { method: 'DELETE' }
      )
  ...
  async function handleAutoDistribute() {
    ...
    try {
      const response = await fetch(
        `/api/admin/events/${eventId}/sessions/${sessionId}/activites-libres/auto-distribute`,
        { method: 'POST' }
      )
      ...
      <div className="p-6">
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <Button onClick={() => router.push(`/admin/events/${eventId}/activites-libres`)}>
              Retour
            </Button>
          </CardContent>
        </Card>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push(`/admin/events/${eventId}/activites-libres`)}
          >
