...
import { Loader2, Save, Eye, Monitor, Layout, Download, Upload, BookOpen } from 'lucide-react'
import { toast } from 'sonner'
import { createClientLogger } from '@/lib/client-logger'

const logger = createClientLogger({ component: 'RsvpStepsContent' })
...
interface RsvpStepsContentProps {
  eventId: string
}

export function RsvpStepsContent({ eventId }: RsvpStepsContentProps) {
