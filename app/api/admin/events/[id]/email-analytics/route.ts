...
const analyticsLogger = createLogger({ module: 'email', type: 'analytics' })
...
export async function GET(
  ...
  try {
    ...
    analyticsLogger.error({ error, stack: error instanceof Error ? error.stack : undefined }, 'Error fetching email analytics')
