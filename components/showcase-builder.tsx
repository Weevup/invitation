...
const availableSections = [
  { id: 'hero', label: 'Hero (Titre et date)', description: 'Section principale avec titre et date' },
  { id: 'description', label: 'Description', description: 'Description détaillée de l\'événement' },
  { id: 'program', label: 'Programme', description: 'Programme de l\'événement' },
  { id: 'details', label: 'Détails', description: 'Lieu, date, code vestimentaire' },
  { id: 'cta', label: 'Appel à l\'action', description: 'Bouton pour retourner à l\'accueil' },
]
...
export function ShowcaseBuilder({ eventId, eventSlug, initialData }: ShowcaseBuilderProps) {
  ...
  const [sections, setSections] = useState<string[]>(
    initialData.showcaseSections || ['hero', 'description', 'details', 'cta']
  )
